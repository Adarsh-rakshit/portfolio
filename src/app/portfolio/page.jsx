...
const items = [
  {
    ...
    desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste aut aliquid possimus debitis dolorem nisi adipisci labore quas illum consectetur!",
    img: "https://verpex.com/assets/uploads/images/blog/How-to-become-a-Backend-Developer.jpg?v=1665484477",
    link: "https://github.com/Adarsh-rakshit/videostream"
  },
  {
    id: 2,
    color: "from-purple-300 to-red-300",
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <Link href={item.link} className="flex justify-end">
                    <button className="p-2 text-sm md:p-4 md:text-md lg:p-8 lg:text-lg bg-white text-gray-600 font-semibold m-4 rounded-3xl">See demo</button>
                  </Link>
                </div>
              </div>
            ))}
